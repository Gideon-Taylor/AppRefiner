    ...
    public class TemplateParameterDialog : Form
    {
        ...
        private void GenerateParameterControls()
        {
            ...
            if (template == null || template.Inputs == null || template.Inputs.Count == 0)
            {
                ...
                // Position buttons
                this.cancelButton.Location = new Point(this.ClientSize.Width - 230, emptyButtonsY);
                this.applyButton.Location = new Point(this.ClientSize.Width - 120, emptyButtonsY);
            ...
            this.cancelButton.Location = new Point(this.ClientSize.Width - 230, buttonsY);
            this.applyButton.Location = new Point(this.ClientSize.Width - 120, buttonsY);
