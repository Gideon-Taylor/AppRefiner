...
namespace AppRefiner.TooltipProviders
{
    ...
    public abstract class BaseTooltipProvider : ScopedAstVisitor<object>
    {
        ...
        public virtual bool CanProvideTooltipAt(ScintillaEditor editor, ProgramNode program, List<Token> tokens, int cursorPosition, int lineNumber)
        {
            return true;
        }
        ...
        public virtual void ProcessProgram(ProgramNode program, int position, int lineNumber)
        {
            try
            {
                Reset();
