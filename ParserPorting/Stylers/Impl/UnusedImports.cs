    ...
    public class UnusedImports : BaseStyler
    {
        ...
        public override void VisitProgram(ProgramNode node)
        {
            ...
            foreach (var import in importUseMap.Values)
            {
                ...
                {
                    AddIndicator(import.Node.SourceSpan, Indicator.IndicatorType.TEXTCOLOR, 0xFF808080, $"Unused import");
                }
            }
        }
        ...
        public override void VisitImport(ImportNode node)
        {
            ...
            {
                /* duplicate import */
                AddIndicator(node.SourceSpan, Indicator.IndicatorType.TEXTCOLOR, 0xFFFFA500, "Duplicate import");
            }
        }
