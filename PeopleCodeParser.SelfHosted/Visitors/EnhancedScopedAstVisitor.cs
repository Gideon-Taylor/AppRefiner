...
public abstract class EnhancedScopedAstVisitor<T> : AstVisitorBase
{
    ...
    /// </summary>
    public IEnumerable<EnhancedVariableInfo> GetAllVariables() => variableRegistry.AllVariables;
    
    #endregion
    
    #region Constructor
    
    protected EnhancedScopedAstVisitor()
    {
    ...
    /// </summary>
    protected void RegisterVariable(VariableNameInfo variableNameInfo, string typeName, VariableKind variableKind)
    {
        var current = GetCurrentScope(); // Will throw if no current scope
        var variable = new EnhancedVariableInfo(variableNameInfo, typeName, variableKind, current);
    ...
    /// </summary>
    protected EnhancedVariableInfo? FindVariable(string name)
    {
    ...
    /// </summary>
    public IEnumerable<EnhancedVariableInfo> GetVariablesDeclaredInScope(ScopeContext scope)
    {
    ...
    public override void VisitMethod(MethodNode node)
    {
        ...
        try
        {
            ...
            foreach (var parameter in node.Parameters)
            {
                ...
                RegisterVariable(nameInfo, typeName, VariableKind.Parameter);
            }
    ...
    public override void VisitProperty(PropertyNode node)
    {
        ...
        RegisterVariable(nameInfo, "Property", VariableKind.Property);
    ...
    public override void VisitVariable(VariableNode node)
    {
        ...
        {
            RegisterVariable(nameInfo, typeName, variableKind);
        }
    ...
    public override void VisitLocalVariableDeclaration(LocalVariableDeclarationNode node)
    {
        ...
        {
            RegisterVariable(node.VariableNameInfos[i], typeName, VariableKind.Local);
        }
    ...
    {
        var typeName = AstTypeExtractor.GetTypeFromNode(node.Type);
        RegisterVariable(node.VariableNameInfo, typeName, VariableKind.Local);
    ...
    public override void VisitConstant(ConstantNode node)
    {
        ...
        RegisterVariable(nameInfo, $"Constant({typeName})", VariableKind.Constant);
    ...
    /// </summary>
    protected virtual void OnVariableDeclared(EnhancedVariableInfo variable) { }
